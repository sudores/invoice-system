...
func (i *InvoicesGrpcService) CreateInvoice(ctx context.Context, req *CreateInvoiceRequest) (*InvoiceResponse, error) {
...
func (i *InvoicesGrpcService) UpdateInvoice(ctx context.Context, req *UpdateInvoiceRequest) (*InvoiceResponse, error) {
